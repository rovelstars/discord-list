if (client.owners.includes(message.author.id)) {
  prompter
    ...
    .then((responses) => {
      if (!responses.size) {
        message.reply({ content: "You left me? Am i a __**JOKE**__ to you?" });
      } else {
        ...
        if (!isrdl && pinged) {
          client.guilds.cache
            ...
            .channels.cache.get("775245886795808768")
            .send(msg);
          client.guilds.cache
            .get("602906543356379156")
            .channels.cache.get("775245886795808768")
          ...
          client.guilds.cache
            .get("602906543356379156")
            .channels.cache.get("830791693904904212")
            .send(msg);
          client.guilds.cache
            .get("602906543356379156")
            .channels.cache.get("830791693904904212")
        ...
        message.channel.bulkDelete(2).then(() => {
          message.channel
            .send(
              "<:good:783358064089759744> Posted the Announcement successfully!"
            )
            .then((msg) => {
              setTimeout(() => {
                msg.delete();
