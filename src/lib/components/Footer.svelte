...
<footer class="mt-12 pt-8 border-t border-border">
	<div class="max-w-5xl mx-auto px-4">
		...
		<!-- Bottom row: disclaimer + socials -->
		<div class="py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
			<p class="text-xs text-muted-foreground text-center sm:text-left max-w-md">
				Rovel Stars™ is not affiliated with Discord Inc. All logos and trademarks are the property
