...
<script context="module" lang="ts">
   ...
   */
  export function LabelHtml({ forId = '', text = '', className = '' }: { forId?: string; text?: string; className?: string }) {
   ...
   */
  export function SkeletonHtml({ width = 'w-full', height = 'h-4', className = '' }: { width?: string; height?: string; className?: string }) {
