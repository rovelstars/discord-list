...
export default function BotPage({ bot }: { bot: Bot }) {
  ...
  return (
    <div className="col-span-3 w-full mx-auto bg-card min-h-screen rounded-lg shadow-black/90">
      ...
      <div
        className="grid grid-cols-1 md:grid-cols-4 md:gap-4 p-4 bg-linear-to-b via-transparent to-transparent "
        style={{
          //@ts-ignore
          ...
          <div className="px-4 mx-auto md:mx-0">
            ...
            >
              ...
              {bot.prefix == "/" || !bot.prefix ? (
                ...
                <span>
                  Prefix is{" "}
                  <span className="font-semibold text-muted-foreground bg-popover py-0.5 px-2 rounded-md border border border-muted-foreground/20">
                    {bot.prefix}
                  </span>
                </span>
              )}
